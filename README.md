...
* **Optimal Parameters:** $\gamma = 0.99$, convergence threshold $\theta = 10^{-6}$.
...
* **Optimal Parameters:** Learning Rate ($\alpha$) = 0.1, Discount Factor ($\gamma$) = 0.99, Epsilon Decay = 0.995.
...
* **Optimal Parameters:** Episodes = 1500, Learning Rate ($\alpha$) = 0.001, Discount Factor ($\gamma$) = 0.99, Batch Size = 64, Epsilon Decay = 0.995.
...
* **Optimal Parameters:** Episodes = 1500, Learning Rate ($\alpha$) = 0.001, Discount Factor ($\gamma$) = 0.99, Batch Size = 64, Epsilon Decay = 0.995, Checkpoint Frequency = every 50 episodes.
